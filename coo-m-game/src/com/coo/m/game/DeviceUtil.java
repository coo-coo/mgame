...
public class DeviceUtil {
	...
	public static int[] getResolution(Context context) {
		...
		DeviceManager.getWindowManger(context).getDefaultDisplay()
				.getMetrics(dm);
	...
	public static String getImsi(Context context) {
		String imsi = DeviceManager.getTelephonyManager(context)
				.getSubscriberId();
		return imsi;
	}

	public static String getDeviceId(Context context) {
		String deviceId = DeviceManager.getTelephonyManager(context)
				.getDeviceId();
		return deviceId;
	}

	/**
	 * ��ȡ��վ��λ��Ϣ ��������Ϊ int[0]=cid int[1]=lac
	 * 
	 * @param context
	 */
	public static int[] getCellLocation(Context context) {
		...
		if (simType.equals("GSM")) {
			GsmCellLocation gsm = (GsmCellLocation) DeviceManager
					.getTelephonyManager(context)
					.getCellLocation();
			i[0] = gsm.getCid();
			i[1] = gsm.getLac();
		} else {
			CdmaCellLocation cdma = (CdmaCellLocation) DeviceManager
					.getTelephonyManager(context)
					.getCellLocation();
	...
	public static String getPhoneType(Context context) {
		String simType = "NONE";
		TelephonyManager tm = DeviceManager.getTelephonyManager(context);
	...
	public static boolean isPad(Context context) {
		WindowManager wm = DeviceManager.getWindowManger(context);
